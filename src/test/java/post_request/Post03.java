...
*/
    ...
    public void post02() {
        ...
        Map<String, String> bookingdatesMap = new HerOkuAppTestData().bookingDates("2021-09-09", "2021-09-21");
        Map<String, Object> expectedData = new HerOkuAppTestData().expectedData("John", "Doe", 11111, true, bookingdatesMap, null);
